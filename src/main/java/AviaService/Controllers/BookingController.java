...
public class BookingController {
   ...
   private BookingService bookService = new BookingService();
    ...
    public List<Booking> getAllBookings() { return bookService.getAllBookings(); }

    public void myBookings(String name, String surname) { bookService.myBookings(name, surname); }

    public List<Booking> addBooking() { return bookService.addBooking(); }
